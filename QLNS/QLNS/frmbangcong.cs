...
namespace QLNS
{
    public partial class frmbangcong : Form
    {
        ...
        private void frmbangcong_Load(object sender, EventArgs e)
        {
            ...
            frmbangcong.FillCombo("SELECT TenPhong FROM PhongBan", comboBox10, "TenPhong", "TenPhong");
            comboBox10.SelectedIndex = -1;
            
            cls.loaddatagridview1(dataGridView1,ds1, "select * from BangCongThuViec");
            //cls.loaddatagridview1(dataGridView2, ds2, "select * from BangCongNhanVien ");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                string update = "update BangCongNhanVien set MaNV='"+cb2.Text+"', MaLuong=N'"+txt50.Text+"',TenPhong=N'"+comboBox10.Text+"', HoTen=N'" + txt53.Text + "',LCB=N'" + txt10.Text + "',PCChucVu=N'" + txt11.Text + "',PCapKhac=N'" + txt12.Text + "',Thuong=N'" + textBox1.Text + "',KyLuat='" + textBox2.Text +"',Thang=N'" + txt13.Text + "',Nam='" + txt14.Text + "',SoNgayCongThang=N'" + txt15.Text + "',SoNgayNghi=N'" + txt16.Text + "',SoGioLamThem=N'" + txt17.Text + "',Luong=N'" + txt52.Text + "',GhiChu='" + txt18.Text + "' where MaNV=N'" + cb2.Text + "'";
                cls.thucthiketnoi(update);
                cls.loaddatagridview1(dataGridView2, ds2, "select * from BangCongNhanVien where TenPhong=N'"+comboBox10.SelectedValue+"'");
                MessageBox.Show("Sửa thành công");
            }
            catch
            {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                string delete = "delete from BangCongNhanVien where MaNV=N'" + cb2.Text + "'";
                if (MessageBox.Show("Bạn có muốn xóa không", "Xóa dữ liệu", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    cls.thucthiketnoi(delete);
                    cls.loaddatagridview1(dataGridView2, ds2, "select * from BangCongNhanVien");
        ...
        {   
            ...
            cls.loadtextboxchiso(txt10, "select * from BangLuongCongTy l where l.MaLuong='" + txt50.Text + "'",1);
            cls.loadtextboxchiso(txt11, "select * from BangLuongCongTy l where l.MaLuong='" + txt50.Text + "'", 2);
            //cls.loadtextboxchiso(txt10, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 4);
            cls.loadtextboxchiso(txt53, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 2);
            //cls.loadtextboxchiso(txt51, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 3);
            // cls.loadtextboxchiso(txt11, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 5);
            cls.loadtextboxchiso(txt12, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 6);
            cls.loadtextboxchiso(textBox1, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 7);
            cls.loadtextboxchiso(textBox2, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 8);
            cls.loadtextboxchiso(txt13, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 9);
            cls.loadtextboxchiso(txt14, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 10);
            cls.loadtextboxchiso(txt15, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 11);
            cls.loadtextboxchiso(txt16, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 12);
            cls.loadtextboxchiso(txt17, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 13);
            cls.loadtextboxchiso(txt52, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 14);
            cls.loadtextboxchiso(txt18, "select * from BangCongNhanVien where MaNV='" + cb2.Text + "'", 15);
        }
        ...
        {
            //cls.loadtextboxchiso(txt28, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 1);
            //cls.loadtextboxchiso(txt29, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 2);
            //cls.loadtextboxchiso(txt30, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 3);
            //cls.loadtextboxchiso(txt31, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 4);
            //cls.loadtextboxchiso(txt32, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 5);
            //cls.loadtextboxchiso(txt33, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 6);
            //cls.loadtextboxchiso(txt34, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 7);
            //cls.loadtextboxchiso(txt35, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 8);
            //cls.loadtextboxchiso(txt36, "select * from BangCongNhanVien where MaNV='" + cb4.Text + "'", 9);
        }

        private void cb5_SelectedIndexChanged(object sender, EventArgs e)
        {
            //cls.loadtextboxchiso(txt37, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 1);
            //cls.loadtextboxchiso(txt38, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 2);
            //cls.loadtextboxchiso(txt39, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 3);
            //cls.loadtextboxchiso(txt40, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 4);
            //cls.loadtextboxchiso(txt41, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 5);
            //cls.loadtextboxchiso(txt42, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 6);
            //cls.loadtextboxchiso(txt43, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 7);
            //cls.loadtextboxchiso(txt44, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 8);
            //cls.loadtextboxchiso(txt45, "select * from BangCongNhanVien where MaNV='" + cb5.Text + "'", 9);
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string insert = "insert into BangCongNhanVien values(N'" + cb2.Text + "',N'" + txt10.Text + "',N'" + txt53.Text + "',N'" + txt50.Text + "'N'" + txt11.Text + "',N'" + txt12.Text + "',N'" + textBox1.Text + "',N'" + textBox2.Text + "',N'" + txt13.Text + "',N'" + txt14.Text + "',N'" + txt15.Text + "',N'" + txt16.Text + "',N'" + txt17.Text + "',N'" + txt18.Text + "')";
                if (!cls.kttrungkhoa(cb2.Text, "select MaNV from BangCongNhanVien"))
                {
                    if (cb2.Text != "")
                    {
                        cls.thucthiketnoi(insert);
        ...
        private void txt50_TextChanged(object sender, EventArgs e)
        {
            ...
            //String i = "select LCB from BangLuongCongTy l where l.MaLuong ='" + txt50.Text + "'" ;
            //cls.thucthiketnoi(i);
        ...
        {
            //frmbangcong.FillCombo("select MaNV from BangCongNhanVien b,a p where b.Khoi=p.Khoi and p.Khoi=N'" + comboBox10.SelectedValue + "'", cb2, "MaNV", "MaNV");
        ...
        {
            frmbangcong.FillCombo("select MaNV from BangCongNhanVien where TenPhong=(select top(1) TenPhong from PhongBan a, TTNVCoBan b where a.MaPhong=b.MaPhong and a.TenPhong=N'" + comboBox10.SelectedValue + "' group by TenPhong)", cb2, "MaNV", "MaNV");
            cb2.DisplayMember = "MaNV";
            cb2.ValueMember = "MaNV";
            cls.loaddatagridview1(dataGridView2, ds2, "select * from BangCongNhanVien b where b.TenPhong=N'" + comboBox10.SelectedValue + "'");
        }
