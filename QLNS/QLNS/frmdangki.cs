...
namespace QLNS
{
    public partial class frmdangki : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string insert = "insert into Users values(N'" + textBox1.Text + "',N'" + textBox2.Text + "',N'" + textBox4.Text + "',N'" + textBox3.Text + "','" + dateTimePicker1.Text + "')";
                if (cls.kttrungkhoa(textBox1.Text, "select * from Users") == true)
                ...
                else
                {
                    ...
                    cls.loaddatagridview(dataGridView1, "select * from Users");
                    //this.Close();
                }
            }
            catch
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                string update = "update Users set Username=N'" + textBox1.Text + "',Pass=N'" + textBox2.Text + "',Quyen=N'" + textBox4.Text + "',Ten=N'" + textBox3.Text + "',Ngaysinh='" + dateTimePicker1.Text + "' where Username='"+textBox1.Text+"'";
        ...
        {
            string delete = "delete from Users where Username=N'" + textBox1.Text + "'";
